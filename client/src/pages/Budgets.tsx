...
function BudgetSettingsModal({
 ...
 const inputClass =
"w-full rounded-md border border-border pl-7 pr-3 py-2 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary";
...
export function Budgets() {
 ...
 className="flex w-full items-center justify-center gap-2 rounded-lg border border-border py-2 font-medium text-muted-foreground hover:bg-muted hover:text-ink transition-colors"
 >
