...
export function Accounts() {
 ...
 {account.isManaged && (
 <span className="inline-block rounded-full bg-blue-soft text-blue-deep text-10 font-medium px-2 py-0.5">
 Managed
 </span>
 )}
 {account.isTaxAdvantaged && (
 <span className="inline-block rounded-full bg-up-soft text-up-deep text-10 font-medium px-2 py-0.5">
 ...
 <SectionLabel as="span">{ownership}</SectionLabel>
 </div>
...
function AccountModal({ open, onClose, onSave, onDelete, account, allAccounts }: AccountModalProps) {
 ...
 className={`w-full rounded-md border px-3 py-2 focus:outline-none focus:ring-1 ${nameError ?"border-down focus:border-down focus:ring-down/30" :"border-border focus:border-primary focus:ring-primary"}`}
 ...
 className="h-4 w-4 rounded border-border"
 />
 <span className="font-medium">Tax-advantaged account</span>
 </label>
 <p className="mt-1 ml-6 tp-caption">
 ...
 className="w-full appearance-none rounded-md border border-border py-2 pl-2 pr-6 text-foreground bg-background"
 >
 ...
 />
 <span className="font-medium">Managed / robo-advisor account</span>
 </label>
 <p className="mt-1 ml-6 tp-caption">
 {hasTrackedHoldings
 ...
 className="h-4 w-4 rounded border-border"
 />
 <span className="font-medium">Hide account</span>
 </label>
 <p className="mt-1 ml-6 tp-caption">
