  ...
  return (
    <div className="relative w-20 shrink-0">
      <input
        ...
        placeholder="0"
        className="w-full rounded border border-border px-2 py-1.5 pr-6 text-right text-sm focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
      />
