...
function RebalanceModal({
 ...
 key={t}
 onClick={() => setTab(t)}
 className={`px-3 py-2 font-medium border-b-2 transition-colors -mb-px ${
 tab === t
...
function AllocationCard({
 ...
 <span className="text-muted-foreground col-span-6 min-w-0 flex items-center gap-x-1 flex-wrap">
