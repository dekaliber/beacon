...
function AdjustmentEventRow({ event, onSaved }: AdjustmentEventRowProps) {
 ...
 if (!editing) {
 return (
 <tr className="group border-b border-border bg-row-warn hover:bg-row-warn-hover transition-colors last:border-b-0">
...
"py-2 pr-4 text-right tp-numeric",
 ...
 return (
 <tr className="border-b border-border bg-row-warn-hover last:border-b-0">
 <td className="py-2 pl-4 pr-4">
 <DatePicker
 compact
 value={date}
...
function EditTransferModal({
 ...
 disabled={saving}
 className="flex items-center gap-1.5 rounded-md px-3 py-2 font-medium text-down hover:bg-down/10 transition-colors disabled:opacity-50"
 >
...
export function CashFlow() {
 ...
 <StatValue as="p" className="font-bold">
 ...
 className={cn(
"flex items-center gap-2 px-3 py-2 font-medium border-b-2 -mb-px transition-colors whitespace-nowrap",
 isActive
