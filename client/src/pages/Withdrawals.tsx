...
function WithdrawalSettingsModal({
 ...
 <div>
 <p className="font-medium mb-0.5">Portfolio Denominator</p>
 ...
 />
 <span>Use current portfolio value ({formatCurrency(portfolioValue)})</span>
 </label>
 <label className="flex items-center gap-2 cursor-pointer">
 <input
 type="radio"
 ...
 <div>
 <p className="font-medium mb-0.5">Target Withdrawal Rate</p>
 <p className="tp-caption">
 ...
 className="w-full rounded-md border border-border pl-3 pr-7 py-2 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
 placeholder="e.g. 4.0"
 />
...
function TransferModal({
 ...
 value={form.amount}
 onChange={set("amount")}
 className={`w-full rounded-md border pl-7 pr-3 py-2 focus:outline-none focus:ring-1 ${errors.amount ?"border-down focus:border-down focus:ring-down/30" :"border-border focus:border-primary focus:ring-primary"}`}
 placeholder="0.00"
 />
 </div>
 ...
 onChange={set("notes")}
 rows={2}
 className="w-full rounded-md border border-border px-3 py-2 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary resize-none"
 />
 </div>

 {/* Managed account notice */}
 {managedInvestmentAccount && (
 <div className="rounded-md bg-warn-soft border border-warn-line px-3 py-2 text-warn-deep">
...
export function WithdrawalsPage() {
 ...
 <li>Stock sale proceeds swept to a bank account</li>
