...
function AssetClassRow({
 ...
 <span className={cn("truncate", isChild ?"" :"font-medium")}>{assetClass.name}</span>
 {assetClass.isSystem && (
...
function AssetClassModal({ open, onClose, onSave, onDelete, editing, isChild }: AssetClassModalProps) {
 ...
 placeholder="e.g. 40"
 className="w-full rounded-md border border-border px-3 py-2 pr-8 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
 />
